...
# API 키
access = "W2NmTNcEYsBtAXASfmMYimxrPhw2tKR4u5NgbbwB"
secret = "mrMjhkOUyTyPszcvh2Us4xOcQjAfkY3mWpJMlPqc"
  ...
  while True:
      try:
          ...
          if not state["bought"] and price <= indicators["entry"]:
              ...
              if krw is None:
                 print("❗ KRW 잔고를 가져오지 못했습니다.")
                 send_telegram_message("❗ KRW 잔고 조회 실패")
                 time.sleep(10)
                 continue
              if krw > 5000:
                  amount = krw * 0.8
